...
class DriverLiveConsumer(AsyncWebsocketConsumer):
    async def connect(self):
        ...
        try:
            ...
            logger.warning("DriverLiveConsumer.connect: invalid driver_id: %s; scope=%s", e,
        ...
        try:
            ...
            logger.exception("DriverLiveConsumer.connect: channel_layer.group_add failed for %s: %s", self.group_name,
                             e)
